  ...
  <div class="shader-scene">
    <div class="controls">
      ...
      <div class="controls-row">
        ...
        <div class="status">
          {{ shaderEnabled ? '✓ Custom Shader' : '✓ Standard Material' }}
        </div>
      </div>

      <div class="info">
        <strong>Animacja:</strong> Falowanie wierzchołków (sin) + puls koloru.
        <span v-if="toonShading"> Toon shading włączony (3 poziomy jasności).</span>
      </div>
    </div>
